...
import cn.cheneya.skypvp.utils.ClientUtil.interaction
import cn.cheneya.skypvp.utils.ClientUtil.player
import cn.cheneya.skypvp.utils.ClientUtil.shouldHideOffhand
...
data class PlayerData(
    ...
    companion object {
        ...
        fun fromPlayer(player: PlayerEntity) = PlayerData(
            ...
            if (shouldHideOffhand(player = player)) ItemStack.EMPTY else player.offHandStack,
